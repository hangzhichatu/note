...
public class HttpUtil {
    ...
    public String sendPost(String url, String parameters, int type, CloseableHttpClient httpClient) {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 302) {
                ...
                String newAddress = header.getValue();
                request = new HttpPost(newAddress);
                request.setEntity(entity);
    ...
    public String sendPostByJson(String url, String params) {
        return sendPost(url, params, Format_Json, createClient(true));
    }
    ...
    public static void main(String[] args) {
        String url = "https://10.9.45.66:8086/open/longi/resource/materialtype/data-import";
        //设置参数
        Map params = new HashMap();
        params.put("insert", true);
        params.put("materialType", "glass");
        String json = JSON.toJSONString(params);
        System.out.println(new HttpUtil().sendPostByJson(url, json));
    }
