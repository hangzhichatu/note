 ...
 */
public class LONGiModuleObjectProcessAndCAReleaseNotifyAction implements LONGiModuleOASendToDoInterface {
    @Override
...
//			ContextUtil.pushContext(context);
            ...
            String noticePersonName = obj.getAttributeValue(context, "LGiM_ModuleMBOMNoticePerson");
            System.out.println("noticePersonName = " + noticePersonName);
            //////////////////////////////////////////////////////////////////////////////////
            // Get state based route objects for this object
            //////////////////////////////////////////////////////////////////////////////////
            String[] noticePersonNameArray = noticePersonName.split("\\|");
            //待办对应接收人
            LONGiModuleTargetBean targetBean = new LONGiModuleTargetBean();
            ArrayList arrayList = new ArrayList();
            for(int i=0;i<noticePersonNameArray.length;i++){
                targetBean.setLoginName(noticePersonNameArray[i]);
...
//			String relSymbolicName = PropertyUtil.getAliasForAdmin(context, "Type", "Project Space", false);
            try {
                ...
                sbBuilder.append("【" + typeName + "：" + obj.getName(context)+"】"+LONGiModuleBPMConfig.PROJECT_OBJECT_RELEASED_Notice);
