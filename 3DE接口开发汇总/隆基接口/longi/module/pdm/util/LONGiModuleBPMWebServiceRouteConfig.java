 ...
 * 
 */
public class LONGiModuleBPMWebServiceRouteConfig {
	private static LONGiModuleBPMWebServiceRouteConfig cfg = new LONGiModuleBPMWebServiceRouteConfig();
	...
	private LONGiModuleBPMWebServiceRouteConfig() {
		loadCfg();
	}

	public static LONGiModuleBPMWebServiceRouteConfig getInstance() {
		return cfg;
	}
