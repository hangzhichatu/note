 ...
 * 
 */
public class LONGiModuleBPMWebServiceTodoConfig {
	private static LONGiModuleBPMWebServiceTodoConfig cfg = new LONGiModuleBPMWebServiceTodoConfig();
	...
	private LONGiModuleBPMWebServiceTodoConfig() {
		loadCfg();
	}

	public static LONGiModuleBPMWebServiceTodoConfig getInstance() {
		return cfg;
	}
