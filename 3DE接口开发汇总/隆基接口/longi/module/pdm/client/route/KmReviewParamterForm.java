...
public class KmReviewParamterForm  implements java.io.Serializable {
    private longi.module.pdm.client.route.AttachmentForm[] attachmentForms;

    private java.lang.String attachmentValues;
    ...
    private java.lang.String fdSource;
    ...
    public KmReviewParamterForm(
           longi.module.pdm.client.route.AttachmentForm[] attachmentForms,
           java.lang.String attachmentValues,
     ...
     */
    public longi.module.pdm.client.route.AttachmentForm[] getAttachmentForms() {
        return attachmentForms;
    }
     ...
     */
    public void setAttachmentForms(longi.module.pdm.client.route.AttachmentForm[] attachmentForms) {
        this.attachmentForms = attachmentForms;
    }

    public longi.module.pdm.client.route.AttachmentForm getAttachmentForms(int i) {
        return this.attachmentForms[i];
    }

    public void setAttachmentForms(int i, longi.module.pdm.client.route.AttachmentForm _value) {
        this.attachmentForms[i] = _value;
    }


    /**
     * Gets the attachmentValues value for this KmReviewParamterForm.
     * 
     * @return attachmentValues
     */
    public java.lang.String getAttachmentValues() {
        return attachmentValues;
    }


    /**
     * Sets the attachmentValues value for this KmReviewParamterForm.
     * 
     * @param attachmentValues
     */
    public void setAttachmentValues(java.lang.String attachmentValues) {
        this.attachmentValues = attachmentValues;
    }
    ...
    /**
     * Gets the fdId value for this KmReviewParamterForm.
     * 
     * @return fdId
     */
    ...
    /**
     * Sets the fdId value for this KmReviewParamterForm.
     * 
     * @param fdId
     */
    ...
    /**
     * Gets the fdSource value for this KmReviewParamterForm.
     * 
     * @return fdSource
     */
    public java.lang.String getFdSource() {
        return fdSource;
    }


    /**
     * Sets the fdSource value for this KmReviewParamterForm.
     * 
     * @param fdSource
     */
    public void setFdSource(java.lang.String fdSource) {
        this.fdSource = fdSource;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.attachmentValues==null && other.getAttachmentValues()==null) || 
             (this.attachmentValues!=null &&
              this.attachmentValues.equals(other.getAttachmentValues()))) &&
            ...
            ((this.fdSource==null && other.getFdSource()==null) || 
             (this.fdSource!=null &&
              this.fdSource.equals(other.getFdSource()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getAttachmentValues() != null) {
            _hashCode += getAttachmentValues().hashCode();
        }
        ...
        if (getFdSource() != null) {
            _hashCode += getFdSource().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("attachmentValues");
        elemField.setXmlName(new javax.xml.namespace.QName("", "attachmentValues"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fdSource");
        elemField.setXmlName(new javax.xml.namespace.QName("", "fdSource"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
