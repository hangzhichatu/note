...
//add by liurui 
function reloadBudgetForm(fieldName, obj){
    ...
    for(var i=0; i < length; i++){
        temp1 = splitString[i];
		if(temp1.indexOf("type=type_")!=-1){
			temp1 = "type=type_"+typeName;
		}
		if(resultURL == ""){
            resultURL = temp1;
        }else{
...
//add by liurui 
var IMPRate;
function isVImpRate(fieldName, obj){
	if(!IMPRate){
		IMPRate = document.forms[0]['IMPRate'].requiredValidate;
	}
	if("WMY" === obj.current.actual){
		$("#IMPRate").removeAttr("disabled");
		$("label[for=IMPRate]").parent().attr("class", "createLabelRequired");
		document.forms[0]['IMPRate'].requiredValidate = IMPRate;
	}else{
		$("#IMPRate").attr("disabled", "disabled");
		$("label[for=IMPRate]").parent().attr("class", "createLabel");
		document.forms[0]['IMPRate'].requiredValidate = "";
		document.getElementsByName("IMPRate")[0].value = "";
	}
}


var IMPPurchaseReasonsForClosedBidding;
function isVBidding(fieldName, obj){
	if(!IMPPurchaseReasonsForClosedBidding){
		IMPPurchaseReasonsForClosedBidding = document.forms[0]['IMPPurchaseReasonsForClosedBidding'].requiredValidate;
	}
	if("GK" === obj.current.actual || "XJ" === obj.current.actual){
		$("#IMPPurchaseReasonsForClosedBidding").attr("disabled", "disabled");
		$("label[for=IMPPurchaseReasonsForClosedBidding]").parent().attr("class", "createLabel");
		document.forms[0]['IMPPurchaseReasonsForClosedBidding'].requiredValidate = "";
		document.getElementsByName("IMPPurchaseReasonsForClosedBidding")[0].value = "";
	}else{
		$("#IMPPurchaseReasonsForClosedBidding").removeAttr("disabled");
		$("label[for=IMPPurchaseReasonsForClosedBidding]").parent().attr("class", "createLabelRequired");
		document.forms[0]['IMPPurchaseReasonsForClosedBidding'].requiredValidate = IMPPurchaseReasonsForClosedBidding;
	}
}

//add by liurui
function checkIsIntNumberForm(fieldName, obj)
{
    var inputStr = obj.current.actual;
	if(parseInt(inputStr)==inputStr)
	{
		return true;
	}else{
		alert('\u4EC5\u5141\u8BB8\u8F93\u5165\u6B63\u6574\u6570!!');
...
function checkIsNumberForm(fieldName, obj)
{
	 var inputStr = obj.current.actual;
	var n = Number(inputStr);
	if (!isNaN(n)){
		return true;
	}else{
		alert('\u4EC5\u5141\u8BB8\u8F93\u5165\u6570\u5B57!');
...
function reloadUnitField(){
	emxFormReloadField('IMPPlmParameterUnit');
}
function changeActualValue(){
	emxFormReloadField('IMPPlmParameterActualValue');
}
function reloadHTCodeField(){
	emxFormReloadField('IMPPurchaseDepartment');
}
var IMPSpecification;
function isDetailsType(fieldName,obj){
	//alert("345");
	/* alert("123");
	emxFormReloadField('IMPSpecification');
	emxFormReloadField('IMPCLClass');
	emxFormReloadField('IMPFWClass');
	emxFormReloadField('IMPGCClass'); */
	
	if("SB" === obj.current.actual){
		$("label[for=IMPSpecification]").parent().attr("class", "createLabelRequired");
		document.getElementById("calc_IMPCLClass").style.display='none';
		document.getElementById("calc_IMPFWClass").style.display='none';
		document.getElementById("calc_IMPGCClass").style.display='none';
		document.getElementById("calc_IMPSpecification").style.display='';
	}else if("CL" === obj.current.actual){	
		$("label[for=IMPCLClass]").parent().attr("class", "createLabelRequired");
		document.getElementById("calc_IMPSpecification").style.display='none';
		document.getElementById("calc_IMPFWClass").style.display='none';
		document.getElementById("calc_IMPGCClass").style.display='none';	
		document.getElementById("calc_IMPCLClass").style.display='';
	}else if("GC" === obj.current.actual){
		$("label[for=IMPGCClass]").parent().attr("class", "createLabelRequired");
		document.getElementById("calc_IMPSpecification").style.display='none';
		document.getElementById("calc_IMPFWClass").style.display='none';
		document.getElementById("calc_IMPCLClass").style.display='none';	
		document.getElementById("calc_IMPGCClass").style.display='';
	}else if("FW" === obj.current.actual){
		$("label[for=IMPFWClass]").parent().attr("class", "createLabelRequired");
		document.getElementById("calc_IMPSpecification").style.display='none';
		document.getElementById("calc_IMPGCClass").style.display='none';
		document.getElementById("calc_IMPCLClass").style.display='none';	
		document.getElementById("calc_IMPFWClass").style.display='';
	}else{
		$("label[for=IMPSpecification]").parent().attr("class", "createLabelRequired");
		document.getElementById("calc_IMPCLClass").style.display='none';
		document.getElementById("calc_IMPFWClass").style.display='none';
 ...
 * @param obj
 */
function isShowAboutChangeAction(fieldName, obj){
    if("Change" === obj.current.actual){
        document.getElementById("calc_IMPInventoryImpact").style.display="";
        document.getElementById("calc_IMPFinanceImpact").style.display="";
        document.getElementById("calc_IMPOwningSystem").style.display="";
        document.getElementById("calc_IMPAffectedSystemId").style.display="";
    }else{
        document.getElementById("calc_IMPInventoryImpact").style.display="none";
        document.getElementById("calc_IMPFinanceImpact").style.display="none";
        document.getElementById("calc_IMPOwningSystem").style.display="none";
        document.getElementById("calc_IMPAffectedSystemId").style.display="none";
    }
}
/**
 * jsm 4/11
 ...
 * @param obj
 */
function isShowAboutChangeAction1(fieldName, obj){
     if(typeof obj.current.actual==='undefined'){
        document.getElementById("calc_IMPInventoryImpact").style.display="none";
        var labelElement1 = document.querySelector('label[for="IMPInventoryImpact"]');
        var trElement1 = labelElement1.closest('tr');
        trElement1.style.display = 'none';
        var selectElement5 = document.getElementById('IMPInventoryImpactId');
        var trElement5 = selectElement5.closest('table').closest('tr');
        trElement5.style.display = 'none';
        var labelElement2 = document.querySelector('label[for="IMPFinanceImpact"]');
        var trElement2 = labelElement2.closest('tr');
        trElement2.style.display = 'none';
        var selectElement6 = document.getElementById('IMPFinanceImpactId');
        var trElement6 = selectElement6.closest('table').closest('tr');
        trElement6.style.display = 'none';
        document.getElementById("calc_IMPOwningSystem").style.display="none";
        var labelElement3 = document.querySelector('label[for="IMPOwningSystem"]');
        var trElement3 = labelElement3.closest('tr');
        trElement3.style.display = 'none';
        var selectElement7 = document.getElementById('IMPOwningSystemId');
        var trElement7 = selectElement7.closest('table').closest('tr');
        trElement7.style.display = 'none';
        var labelElement4 = document.querySelector('label[for="IMPAffectedSystem"]');
        var trElement4 = labelElement4.closest('tr');
        trElement4.style.display = 'none';
        var selectElement8 = document.getElementById('IMPAffectedSystemId');
        var trElement8 = selectElement8.closest('table').closest('tr');
        trElement8.style.display = 'none';
    }else if("Change" === obj.current.actual){
        document.getElementById("calc_IMPInventoryImpact").style.display="";
        var labelElement1 = document.querySelector('label[for="IMPInventoryImpact"]');
        var trElement1 = labelElement1.closest('tr');
        ...
        var selectElement5 = document.getElementById('IMPInventoryImpactId');
        var trElement5 = selectElement5.closest('table').closest('tr');
        trElement5.style.display = '';
        var labelElement2 = document.querySelector('label[for="IMPFinanceImpact"]');
        var trElement2 = labelElement2.closest('tr');
        trElement2.style.display = '';
        var selectElement6 = document.getElementById('IMPFinanceImpactId');
        var trElement6 = selectElement6.closest('table').closest('tr');
        trElement6.style.display = '';
        document.getElementById("calc_IMPOwningSystem").style.display="";
        var labelElement3 = document.querySelector('label[for="IMPOwningSystem"]');
        var trElement3 = labelElement3.closest('tr');
        trElement3.style.display = '';
        var selectElement7 = document.getElementById('IMPOwningSystemId');
        var trElement7 = selectElement7.closest('table').closest('tr');
        trElement7.style.display = '';
        var labelElement4 = document.querySelector('label[for="IMPAffectedSystem"]');
        var trElement4 = labelElement4.closest('tr');
        trElement4.style.display = '';
        var selectElement8 = document.getElementById('IMPAffectedSystemId');
        var trElement8 = selectElement8.closest('table').closest('tr');
        trElement8.style.display = '';
    }else{
        document.getElementById("calc_IMPInventoryImpact").style.display="none";
        var labelElement1 = document.querySelector('label[for="IMPInventoryImpact"]');
        var trElement1 = labelElement1.closest('tr');
