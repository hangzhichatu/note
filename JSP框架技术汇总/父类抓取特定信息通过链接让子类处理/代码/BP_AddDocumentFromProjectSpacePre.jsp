...
<%
	...
	String sflag = "false";
	if(sType.equals("Workspace Vault")||sType.equals("Controlled Folder")){
		sflag="true";
	...
	String redirectToURL = "../common/emxIndentedTable.jsp?program=BP_TableGetItemsJPO:getAllProjectSpaceRelatedDocument&table=BPAddProjectSpaceDocumentTable&header=\u9009\u62e9\u6587\u6863&cancelLabel=\u53d6\u6d88&submitURL=../teamcentral/BP_AddDocumentFromProjectSpace.jsp&submitLabel=\u63d0\u4ea4&WorkspaceVaultId="+stringListParam+"&ProjectSpaceId="+sobjectId+"&targetLocation=slidein";
