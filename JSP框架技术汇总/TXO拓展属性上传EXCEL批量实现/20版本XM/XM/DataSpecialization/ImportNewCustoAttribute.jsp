...
<%@page	import="com.matrixone.apps.domain.*,com.matrixone.apps.domain.util.*,matrix.util.*,matrix.db.Context,com.matrixone.servlet.Framework"%>
...
String loadPage = "";
try{
	currentTypeId = emxGetParameter(request, "objectId");
	System.out.println("currentTypeId=====" + currentTypeId);
	loadPage = "ImportNewCustoAttribute_2.jsp?currentTypeId=" + currentTypeId;
